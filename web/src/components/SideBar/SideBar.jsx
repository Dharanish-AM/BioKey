  ...
  return (
    <div className="sidebar-container">
      <div className="sidebar-navs">
        ...
        <Link
          to="/folders"
          className={`sidebar-nav-item ${location.pathname === "/folder" ? "active" : ""}`}
        >
        ...
        <Link
          to="/favourites"
          className={`sidebar-nav-item ${location.pathname === "/favourites" ? "active" : ""}`}
        >
        ...
        <Link
          to="/storage"
          className={`sidebar-nav-item ${location.pathname === "/storage" ? "active" : ""}`}
        >
