...
export default function Accounts({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container} edges={["left", "right", "bottom"]}>
          ...
          <FlatList
            ...
            renderItem={({ item }) =>
              renderInputField(
                ...
                userData[item],
                (text) => setUserData((prev) => ({ ...prev, [item]: text })),
                `Enter ${item.charAt(0).toUpperCase() + item.slice(1)}`,
                item === "email"
                  ? "email-address"
                  : item === "phone"
                    ? "phone-pad"
          ...
          <View style={styles.overlay1}>
            <View style={styles.moreOptionsContainer}>
              <TouchableOpacity onPress={() => setIsMoreOption(false)}>
                <Text style={[styles.option, { color: colors.red }]}>
                  Delete Account
                </Text>
              </TouchableOpacity>
            </View>
      ...
      {isProfileOpen && (
        <BlurView
          onTouchEnd={() => setIsProfileOpen(false)}
        ...
        <View style={styles.overlay}>
          <View
            style={[
              ...
              isKeyboardVisible && { marginBottom: hp("25%") },
            ]}
          >
            ...
            <View style={styles.buttonContainer}>
              ...
              <Text
                style={[styles.modalOptions, { color: "#9366E2" }]}
