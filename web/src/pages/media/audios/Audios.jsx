                        ...
                        sortedAudios.map((audio) => (
                            ...
                            >
                                <div className="audio-list-item-audio-container">
                                    <FaHeadphonesSimple color="var(--text-color3)" size={"2.3rem"} style={{
                                        position: "absolute",
                                        zIndex: 1,
                                        opacity: "0.8"
                                    }} />
                                    <div className="audio-overlay-black"></div>
                                    <img src={audio.thumbnail} alt={audio.fileName} className="audio-thumbnail" />
                                </div>
                                <div className="audio-list-item-details">
                                    <span className="audio-list-item-name">{audio.name}</span>
                                    <span className="audio-list-item-size">{formatFileSize(audio.size)}</span>
                                </div>
                            </div>
                        ))
                    ) : (
