  ...
  const renderThumbnail = (file) => {
    ...
    switch (type) {
      ...
      case "videos":
        return (
          <>
            <div className="video-list-item-video-container-recent">
              <FaPlay
    ...
    <div className="home-container">
      <div className="home-header">
        <div className="home-header-text">
          Hello, {user.userName}! Your Vault Awaits.
        </div>
          ...
          <div className="home-storage-content">
            <div className="home-storage-text-container">
              ...
              <div className="home-storage-space-text">
                {formatFileSize(usedSpaceBytes)} /{" "}
                {formatFileSize(totalSpaceBytes)}
              </div>
            </div>
            <div className="home-storage-progress-track">
              <div
                className="home-storage-progress-bar"
                ...
                >
                  ...
                  {isShowFileOptions && moreOptionsFile?.name === file.name && (
                    <div
                      ...
                      className="recent-file-more-options"
                    >
                      <div className="recent-file-more-option">View Info</div>
                      <div
                        style={{
                          color: "var(--red)",
                        }}
                        className="recent-file-more-option"
                        onClick={() => {}}
                      >
                        Delete
                      </div>
