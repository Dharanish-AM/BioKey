...
export default function Others() {
    ...
    return (
        <div className="others-container">
                        ...
                        sortedOthers.map((other) => (
                            ...
                            >
                                <div className="other-list-item-other-container">
                                    <FileIcon fold={true} radius={3} extension={getFileExtension(other.name)} {...defaultStyles[getFileExtension(other.name)]
                                    } />
                                </div>
                                <div className="other-list-item-details">
                                    <span className="other-list-item-name">{other.name}</span>
                                    <span className="other-list-item-size">{formatFileSize(other.size)}</span>
                                </div>
                            </div>
                        ))
                    ) : (
            ...
            {
                isShowSortOptions && <div className="others-sort-dropdown">
