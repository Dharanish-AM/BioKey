              ...
              try {
                if (fs.existsSync(tempThumbnailPath)) {
                  const thumbnailBuffer =
                    await fs.promises.readFile(tempThumbnailPath);
                  await minioClient.putObject(
                    process.env.MINIO_BUCKET_NAME,
                    thumbnailPath,
                    thumbnailBuffer,
                  ...
                  reject(
                    new Error("Thumbnail file not found after processing"),
                  );
                }
              } catch (error) {
...
const getUniqueFilePath = async (
  ...
  let fileExists = await minioClient
    .statObject(bucketName, uniqueFileName)
    .catch((err) => {
      return null;
    });
